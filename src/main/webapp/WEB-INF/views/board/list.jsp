...
$(document).ready(function(){
	...
	$(".page-link").on("click", function(e) {
		...
		e.preventDefault();//a태그 무효화시키는거.
		
		var targetPage = $(this).attr("href");//href 속성값 가져오기
		
		console.log(targetPage);
		
		//find키워드로 하위태그 찾음. targetPage값으로 변경 
